...
public class pojo_Current_Election_Candidate {

    public String candidate_image,candidate_name,candidate_father_husband,candidate_party,candidate_age,candidate_gender,candidate_address,
            candidate_applied_state,candidate_applied_constituency;
    public String image;

    public pojo_Current_Election_Candidate(String candidate_image,String candidate_name, String candidate_father_husband, String candidate_party, String candidate_age, String candidate_gender, String candidate_address, String candidate_applied_state, String candidate_applied_constituency) {
