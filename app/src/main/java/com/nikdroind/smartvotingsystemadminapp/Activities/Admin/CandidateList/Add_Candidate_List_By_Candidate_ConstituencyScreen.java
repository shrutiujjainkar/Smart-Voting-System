...
public class Add_Candidate_List_By_Candidate_ConstituencyScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add__candidate__list__by__candidate__constituency_screen);
    ...
    private void init() {
        edt_candidate_name = findViewById(R.id.edt_add_candidate_list_election_candidate_name);
        edt_candidate_father_husband_name = findViewById(R.id.edt_add_candidate_list_election_candidate_father_husband_name);
        edt_candidate_party = findViewById(R.id.edt_add_candidate_list_election_candidate_party);
        edt_candidate_age = findViewById(R.id.edt_add_candidate_list_election_candidate_age);
        edt_candidate_gender = findViewById(R.id.edt_add_candidate_list_election_candidate_gender);
        edt_candidate_address = findViewById(R.id.edt_add_candidate_list_election_candidate_address);
        edt_candidate_applied_state = findViewById(R.id.edt_add_candidate_list_election_candidate_applied_state);
        tv_candidate_applied_constituency = findViewById(R.id.tv_candidate_list_election_candidate_applied_Constitueny);
//    edt_candidate_applied_constituency = findViewById(R.id.edt_add_candidate_list_election_candidate_applied_Constitueny);
        edt_candidate_applied_constituency_pincode = findViewById(R.id.edt_add_candidate_list_candidate_applied_constituncy_pincode);

        btn_select_candidate_image = findViewById(R.id.btn_add_candidate_list_election_candidate_image);
        img_candidate_profile = findViewById(R.id.img_add_candidate_list_election_candidate_image);
        btn_add_candidate = findViewById(R.id.btn_add_candidate_list_election_candidate);
...
//        }
        ...
        {
            add_Candidate_List_Election_Candidate();
        }
    }

    private void add_Candidate_List_Election_Candidate() {
        ...
        client.post(Config.url_add_candidate_list_election_candidate,params,new JsonHttpResponseHandler() {
            @Override
            public void onStart() {
            ...
            public void onSuccess(int statusCode, Header[] headers, final JSONObject response) {
                ...
                try {
                    ...
                    {
                        Toast.makeText(Add_Candidate_List_By_Candidate_ConstituencyScreen.this, "Already Register", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Toast.makeText(Add_Candidate_List_By_Candidate_ConstituencyScreen.this, "Could not Connect", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void uploadBitmap(final Bitmap bitmap, final int lastinsertedid) {
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, Config.url_add_candidate_list_election_candidate_image,
                new Response.Listener<NetworkResponse>() {
                    @Override
                    public void onResponse(NetworkResponse response) {
                        startActivity(new Intent(Add_Candidate_List_By_Candidate_ConstituencyScreen.this, Candidate_List_By_Candidate_Election_Type_and_ConstituencyScreen.class));
                        finish();
                    }
                },
